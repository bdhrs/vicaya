...
- **Rules:**
    ...
    - Section 2's negative claims ("the EBTs don't say X", "image X is a later trope") are the highest-risk claims in the note — verify each against the canon DB before asserting it, running the full absence procedure of Hard Rule 13 across all T1a books, verse texts included. A real run nearly called the mirage simile a later Mahāyāna development when SN22.95 uses it for saññā.
